<template>
  <el-card title="">
    <div class="btnContainer">
      <el-space>
        <el-input v-model="currentPage" />
        <el-button type="primary" @click="back">返回</el-button>
        <el-button type="primary" @click="contentVisable = true">显示目录</el-button>
        <el-button type="primary" @click="refresh">刷新</el-button>
        <el-button type="primary" @click="prev">上一话</el-button>
        <el-button type="primary" @click="next">下一话</el-button>
  ...
  <el-dialog v-model="contentVisable" title="目录" width="400px" @ok="contentVisable = false">
    <div class="des">
      {{ details?.des || '无' }}
    </div>
    <div class="content">
